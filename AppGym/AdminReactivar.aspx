<%@ Page Title="" Language="C#" MasterPageFile="~/MymasterPage.Master" AutoEventWireup="true" CodeBehind="AdminReactivar.aspx.cs" Inherits="AppGym.AdminReactivar" %>
...
<div>
      ...
      <div class="body">
        ...
        <div class="card" >
          <div class="card-body">
            <h5 class="card-title">Reactivar Instructor/Usuario</h5>
            
            <p class="card-text">Se podra reactivar algun Instructor/Usuario dado de baja</p>
    ...
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Reactivar Cliente</h5>
        <p class="card-text">Se podra reactivar algun cliente que haya sido dado de baja</p>
        <asp:Button ID="btnReactivarCliente" CssClass="btn btn-primary" runat="server" Text="Ir a reactivar" OnClick="btnReactivarCliente_Click" />
      </div>
    </div>
