<%@ Page Title="" Language="C#" MasterPageFile="~/MymasterPage.Master" AutoEventWireup="true" CodeBehind="AdminPageInicio.aspx.cs" Inherits="AppGym.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div>
            <h3>Bienvenido </h3>
            <asp:Label ID="lblInicioSesion" runat="server" Text=""></asp:Label>
        </div>
