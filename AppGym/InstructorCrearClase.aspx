<%@ Page Title="" Language="C#" MasterPageFile="~/MymasterPage.Master" AutoEventWireup="true" CodeBehind="InstructorCrearClase.aspx.cs" Inherits="AppGym.InstructorCrearClase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:Button ID="btnEnviar" runat="server" Text="Enviar solicitud" CssClass="btn btn-primary" OnClick="btnEnviar_Click"/>
