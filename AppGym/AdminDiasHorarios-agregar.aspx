<%@ Page Title="" Language="C#" MasterPageFile="~/MymasterPage.Master" AutoEventWireup="true" CodeBehind="AdminDiasHorarios-agregar.aspx.cs" Inherits="AppGym.AdminDiasHorarios_agregar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:Label ID="lblTitulo" runat="server" CssClass="form-label" Font-Size="Large" Text="Agregar el horario del gimnasio"></asp:Label>
    </div>
    ...
    <div class="card" style="width: 18rem;">
      <div class="card-body">
            <div>
                ...
                <asp:Label ID="lblSeleccionDia" runat="server" Text="Selecciona un día: "></asp:Label>
          ...
          <asp:Button ID="btnAddDia" CssClass="btn btn-primary" runat="server" Text="Agregar dia"  OnClick="btnAddDia_Click"/>
      </div>
    </div> 
    ...
    <div>
        ...
        <asp:GridView ID="gvDiasHorarios" runat="server" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:BoundField DataField="horaInicio" HeaderText="Horario" />
                    <asp:BoundField DataField="horaFin" HeaderText="Horario" />
